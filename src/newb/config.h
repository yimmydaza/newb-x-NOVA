...
#define NL_CONTRAST 1.2             // 0.3 low ~ 2.0 high
...
#define NL_MORNING_SUN_COL vec3(3.0,2.0,0.0)
#define NL_NOON_SUN_COL    vec3(5.0,5.0,0.0)
#define NL_NIGHT_SUN_COL   vec3(0.0,0.5,1.0)
...
#define NL_MIST_DENSITY 0.001      // 0.0 no mist ~ 1.0 misty
...
#define NL_DAY_ZENITH_COL    vec3(0.2,0.7,3.0)
#define NL_DAY_HORIZON_COL   vec3(0.3,1.3,3.9)

#define NL_NIGHT_ZENITH_COL  vec3(0.03,0.08,0.3)
#define NL_NIGHT_HORIZON_COL vec3(0.015,0.45,1.1)
...
#define NL_DAWN_ZENITH_COL   vec3(1.0,1.0,0.5)
#define NL_DAWN_EDGE_COL     vec3(1.0,0.3,0.0)
#define NL_DAWN_HORIZON_COL  vec3(1.0,0.4,0.0)
...
#define NL_CLOUD2_SCALE 0.1        // 0.003 large ~ 0.3 tiny
...
/* Sky reflection */
//#define NL_GROUND_REFL 0.01       // [toggle] 0.2 slightly reflective ~ 1.0 fully reflect sky 
#define NL_GROUND_RAIN_WETNESS 1.0 // 0.0 no wetness ~ 1.0 fully wet blocks when raining
#define NL_GROUND_RAIN_PUDDLES 0.12 // 0.0 no puddles ~ 1.0 puddles
